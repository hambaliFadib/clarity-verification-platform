...
const statements = [
  ...
  `alter table defects add column if not exists linked_test_case varchar(20)`,
  `alter table defects add column if not exists linked_test_run varchar(120)`,
  `alter table defects add column if not exists environment varchar(120)`,
  `alter table defects add column if not exists browser varchar(120)`,
  `alter table defects add column if not exists steps_to_reproduce text`,
  `alter table defects add column if not exists tags text[]`,
