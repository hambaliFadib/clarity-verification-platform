...
async function run() {
  ...
  const columns = [
    ...
    { header: "Menu", key: "subModule", width: 20 },
    { header: "Scenario / Suite", key: "scenario", width: 25 },
    ...
    { header: "Notes / Evidence", key: "notes", width: 24 },
    { header: "Author", key: "author", width: 18 },
    { header: "Date Created", key: "createdAt", width: 18 },
    { header: "Sprint / Release", key: "releaseVersion", width: 18 },
    { header: "Automation?", key: "isAutomated", width: 14 },
  ];
